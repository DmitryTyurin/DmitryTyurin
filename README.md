#### 💻 Дата инженер 📚 Изучаю инструменты и методы для работы с большими данными. 🎯 Использую свой опыт и знания для создания решений в области данных. 💾 Ниже представлены мои небольшие проекты по работе с данными, а также реализация задании курсов по Python, SQL и др.
