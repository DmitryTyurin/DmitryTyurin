#### 💻 Дата инженер 📚 изучаю инструменты и методы для работы с большими данными. 
#### 🎯 Использую свой опыт и знания для создания решений области данных. 
#### 💾 Здесь будут представлены мои небольшие проекты по работе с данными.
